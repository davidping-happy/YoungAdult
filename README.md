...
- 雲端 API：https://youngadult-api.onrender.com/api
- 健康檢查：https://youngadult-api.onrender.com/api/health
...
API 已部署於 Render：`https://youngadult-api.onrender.com`。  
管理後台也可部署為 `https://youngadult-admin.onrender.com`（見下方 Blueprint）。
